...
module "vnet" {
  ...
  virtual_network_name = "vnet-dev-weu-001"
...
module "pip1" {
  ...
  public_ip_name = "bastion-pip-dev-001"
  rg_name        = "rg-dev-weu-001"
  location       = "West Europe"
...
module "nic_bpepool_assoc" {
  ...
  nic_name2                 = "vm-nic-dev-002"
  ip_configuration_name     = "vm-ip-config"
  lb_name                   = "lb-dev-weu-001"
  backend_address_pool_name = "lbbpool-dev-001"
}
...
module "lb" {
  ...
  lb_name                        = "lb-dev-weu-001"
  backend_address_pool_name      = "lbbpool-dev-001"
  lb_probe_name                  = "lbprobe-dev-001"
  lb_rule_name                   = "lbrule-dev-001"
  frontend_ip_configuration_name = "fip-lb-dev-001"
  rg_name                        = "rg-dev-weu-001"
  location                       = "West Europe"
  public_ip_name                 = "lb-pip-dev-001"
}
